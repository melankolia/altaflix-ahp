<template>
  <div class="d-flex flex-column mb-10">
    ...
    <ContentNotFound
      message="Data Tentang Diri Karyawan Not Found"
      :loading="loading"
    ...
    <div v-else class="d-flex flex-column">
      ...
      <v-row>
        ...
        <v-col cols="12" xs="12" sm="2">
          ...
          <v-text-field
            v-model="payload.tempatLahir"
            hide-details
            filled
            solo
            label="Contoh : Jakarta"
          />
        </v-col>
        <v-col cols="12" xs="12" sm="4">
          ...
          <v-menu
            ...
            offset-y
            min-width="290px"
            :return-value.sync="payload.tanggalLahir"
          >
            ...
            <v-date-picker v-model="payload.tanggalLahir">
              ...
              <v-btn
                text
                color="primary"
                @click="$refs.birthMenu.save(payload.tanggalLahir)"
              >
                OK
              </v-btn>
            </v-date-picker>
      ...
      <v-row>
        ...
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-select
            v-model="payload.statusPernikahan"
            :items="listPernikahan"
            hide-details
            filled
            solo
      ...
      <v-row>
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-textarea
            ...
            filled
            solo
            label="Contoh: Jl. Jendral Sudirman"
            clearable
          />
        </v-col>
        <v-col cols="12" xs="12" sm="6">
      ...
      <v-row>
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-select
            v-model="payload.pendidikanTerakhir"
        ...
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-select
            v-model="payload.statusKaryawan"
            :items="listStatusKaryawan"
            hide-details
            filled
            solo
      ...
      <v-row>
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-select
            ...
            label="Pilih Projek"
            clearable
            item-text="namaProjek"
            item-value="projek_id"
            return-object
          />
        </v-col>
        <v-col cols="12" xs="12" sm="6">
      ...
      <v-row>
        ...
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-text-field
            v-model="payload.noKTP"
            hide-details
            filled
            solo
            label="Contoh: 16710239292"
            clearable
          />
        </v-col>
      </v-row>
      <v-row>
        ...
        <v-col cols="12" xs="12" sm="6">
          ...
          <v-menu
            ref="menu"
            v-model="tanggalMasukMenu"
            :close-on-content-click="false"
            transition="scale-transition"
            offset-y
            min-width="290px"
            :return-value.sync="payload.tanggalMasuk"
          >
            <template v-slot:activator="{ on }">
              <v-text-field
            ...
            <v-date-picker v-model="payload.tanggalMasuk">
              ...
              <v-btn
                text
                color="primary"
                @click="$refs.menu.save(payload.tanggalMasuk)"
              >
                OK
              </v-btn>
            </v-date-picker>
        ...
        KaryawanService.addKaryawan(payload)
          .then(({ data: { result, message } }) => {
            if (message == "OK") {
              ...
              this.$store.commit("snackbar/setSnack", {
                show: true,
                message: result || "Gagal Menyimpan Data Karyawan",
                color: "error",
              });
            }
          })
