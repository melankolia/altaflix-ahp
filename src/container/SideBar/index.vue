<template>
  <v-navigation-drawer style="overflow: visible !important" app permanent :mini-variant.sync="mini" width="308px"
    mini-variant-width="104px">
    <div style="height: 100%" class="d-flex flex-column justify-space-between pb-10">
      <div>
        <v-list>
          <v-list-item style="transition: all 0.7s" :class="{ 'px-2 pt-4': mini, 'pl-10 pt-4': !mini }">
            <v-list-item-avatar>
              <v-img src="@/assets/image/logo-altaflix.png"></v-img>
            </v-list-item-avatar>
            <v-list-item-content>
              <p class="smansa-title ma-0">ALTAFLIX</p>
            </v-list-item-content>
          </v-list-item>
        </v-list>
    ...
    <v-btn elevation="4" class="fab-toggle white" x-small fab icon @click.stop="mini = !mini">
      <v-icon>{{
      ...
      items: [
        {
          ...
          subItems: [
            ...
            {
              title: "Kriteria dan Subkriteria",
              to: { name: KRITERIA.BROWSE },
            },
          ],
          active: true,
        },
        {
          ...
          subItems: [
            {
              title: "Seluruh Karyawan",
              to: { name: KARYAWAN.BROWSE },
            },
          ],
          active: false,
        },
